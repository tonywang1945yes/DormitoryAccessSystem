...
//        this.outputExcelPath = inputExcelPath.substring(0, inputExcelPath.lastIndexOf("\\")) + "\\output.xlsx";
...
//        this.inputExcelPath = System.getProperty("user.dir") + "\\input.xlsx";
//        this.outputExcelPath = System.getProperty("user.dir") + "\\失踪学生名单_不包含白名单.xlsx";
//    }
//
...
//        List<People> people = ExcelReader.readSimpleExcel(inputExcelPath, "辅导员");
//        Tutor t;
...
//        //getWhiteList
//        List<People> people = ExcelReader.readSimpleExcel(inputExcelPath, "白名单");
//        Student s;
//        for(int i = 0; i < people.size(); i++){
